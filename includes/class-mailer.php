...
final class Mailer {
	...
	private static function descriptions(): array {
		return [
			...
			'2fa.api_auth_refused'                => __( 'API login with the account password refused (two-factor active): %1$s', 'wp-security-center' ),
			...
			'login.blocked_denylist'              => __( 'Login BLOCKED from an address on the deny list: %1$s', 'wp-security-center' ),
